  ...
  return (
    <>
      <Button
        ...
        type="primary"
      >
        {apifoxEntryLabel(props.profile)}
      </Button>
      <Modal
      ...
      >
        <section
          className="apifox-sync-panel apifox-modal-scroll"
          onWheel={(event) => event.stopPropagation()}
        >
          <div className="apifox-panel-head">
            <div>
              <span>APIFOX OPENAPI</span>
              <strong>在线项目配置</strong>
            </div>
          </div>
          <Form className="apifox-form" layout="vertical" requiredMark={false}>
            ...
            <div className="apifox-form-actions">
              <Button
  ...
  return (
    <div className="tag-sync-row">
      <Alert
        ...
        message={`连接验证成功，共发现 ${props.availableTags.length} 个可选 Tag`}
        showIcon
        type="success"
      />
      <TagMultiSelect
...
function TagMultiSelect(props: {
  ...
  return (
    <Select
      ...
      options={props.options.map((tag) => ({ label: tag, value: tag }))}
      placeholder="请选择 Tag"
      showSearch
      value={props.value}
    />
...
function InterfacePreviewPanel(props: {
  ...
  return (
    <div className="interface-preview">
      ...
      <List
        className="interface-preview-list"
